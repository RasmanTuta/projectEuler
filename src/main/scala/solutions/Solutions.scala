...
object Solution_11{
  def main(args: Array[String]) {
    ...
    val ints = grid.split("""\s+""").map(_.toInt)

    val h = ((0 to 19), 0, 16, 1, 2, 3)
    val d1 = ((0 to 16), 0, 16, 21, 42, 63)
    val d2 = ((0 to 16), 3, 19, 19, 38, 57)
    val v = ((0 to 16), 0, 19, 20, 40, 60)
